...
public partial class LinqToQuerystringLexer : Antlr.Runtime.Lexer
{
	...
	private void mT__70()
	{
		...
		try
		{
			...
			// LinqToQuerystring.g:23:7: ( '&' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:23:9: '&'
			{
			DebugLocation(23, 9);
			Match('&'); 
	...
	private void mT__71()
	{
		...
		try
		{
			int _type = T__71;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:24:7: ( '(' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:24:9: '('
			{
			DebugLocation(24, 9);
			Match('('); 
	...
	private void mT__72()
	{
		...
		try
		{
			int _type = T__72;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:25:7: ( ')' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:25:9: ')'
			{
			DebugLocation(25, 9);
			Match(')'); 
	...
	private void mT__73()
	{
		...
		try
		{
			int _type = T__73;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:26:7: ( ',' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:26:9: ','
			{
			DebugLocation(26, 9);
			Match(','); 
	...
	private void mT__74()
	{
		...
		try
		{
			int _type = T__74;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:27:7: ( '/' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:27:9: '/'
			{
			DebugLocation(27, 9);
			Match('/'); 
	...
	private void mT__75()
	{
		...
		try
		{
			int _type = T__75;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:28:7: ( ':' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:28:9: ':'
			{
			DebugLocation(28, 9);
			Match(':'); 
	...
	private void mASSIGN()
	{
		...
		try
		{
			int _type = ASSIGN;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:128:2: ( '=' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:128:5: '='
			{
			DebugLocation(128, 5);
			Match('='); 
	...
	private void mEQUALS()
	{
		...
		try
		{
			int _type = EQUALS;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:131:2: ( 'eq' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:131:4: 'eq'
			{
			DebugLocation(131, 4);
			Match("eq"); 
	...
	private void mNOTEQUALS()
	{
		...
		try
		{
			int _type = NOTEQUALS;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:134:2: ( 'ne' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:134:4: 'ne'
			{
			DebugLocation(134, 4);
			Match("ne"); 
	...
	private void mGREATERTHAN()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:137:2: ( 'gt' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:137:4: 'gt'
			{
			DebugLocation(137, 4);
			Match("gt"); 
	...
	private void mGREATERTHANOREQUAL()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:140:2: ( 'ge' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:140:4: 'ge'
			{
			DebugLocation(140, 4);
			Match("ge"); 
	...
	private void mLESSTHAN()
	{
		...
		try
		{
			int _type = LESSTHAN;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:143:2: ( 'lt' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:143:4: 'lt'
			{
			DebugLocation(143, 4);
			Match("lt"); 
	...
	private void mLESSTHANOREQUAL()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:146:2: ( 'le' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:146:4: 'le'
			{
			DebugLocation(146, 4);
			Match("le"); 
	...
	private void mNOT()
	{
		...
		try
		{
			int _type = NOT;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:149:2: ( 'not' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:149:4: 'not'
			{
			DebugLocation(149, 4);
			Match("not"); 
	...
	private void mOR()
	{
		...
		try
		{
			int _type = OR;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:152:2: ( 'or' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:152:4: 'or'
			{
			DebugLocation(152, 4);
			Match("or"); 
	...
	private void mAND()
	{
		...
		try
		{
			int _type = AND;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:155:2: ( 'and' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:155:5: 'and'
			{
			DebugLocation(155, 5);
			Match("and"); 
	...
	private void mASC()
	{
		...
		try
		{
			int _type = ASC;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:158:2: ( 'asc' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:158:4: 'asc'
			{
			DebugLocation(158, 4);
			Match("asc"); 
	...
	private void mDESC()
	{
		...
		try
		{
			int _type = DESC;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:161:2: ( 'desc' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:161:4: 'desc'
			{
			DebugLocation(161, 4);
			Match("desc"); 
	...
	private void mALLPAGES()
	{
		...
		try
		{
			int _type = ALLPAGES;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:164:2: ( 'allpages' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:164:5: 'allpages'
			{
			DebugLocation(164, 5);
			Match("allpages"); 
	...
	private void mNONE()
	{
		...
		try
		{
			int _type = NONE;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:167:2: ( 'none' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:167:4: 'none'
			{
			DebugLocation(167, 4);
			Match("none"); 
	...
	private void mSKIP()
	{
		...
		try
		{
			int _type = SKIP;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:170:2: ( '$skip=' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:170:4: '$skip='
			{
			DebugLocation(170, 4);
			Match("$skip="); 
	...
	private void mTOP()
	{
		...
		try
		{
			int _type = TOP;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:173:2: ( '$top=' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:173:4: '$top='
			{
			DebugLocation(173, 4);
			Match("$top="); 
	...
	private void mFILTER()
	{
		...
		try
		{
			int _type = FILTER;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:176:2: ( '$filter=' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:176:4: '$filter='
			{
			DebugLocation(176, 4);
			Match("$filter="); 
	...
	private void mORDERBY()
	{
		...
		try
		{
			int _type = ORDERBY;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:179:2: ( '$orderby=' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:179:4: '$orderby='
			{
			DebugLocation(179, 4);
			Match("$orderby="); 
	...
	private void mSELECT()
	{
		...
		try
		{
			int _type = SELECT;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:182:2: ( '$select=' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:182:4: '$select='
			{
			DebugLocation(182, 4);
			Match("$select="); 
	...
	private void mINLINECOUNT()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:185:2: ( '$inlinecount=' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:185:4: '$inlinecount='
			{
			DebugLocation(185, 4);
			Match("$inlinecount="); 
	...
	private void mEXPAND()
	{
		...
		try
		{
			int _type = EXPAND;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:187:8: ( '$expand=' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:187:10: '$expand='
			{
	...
	private void mIGNORED()
	{
		...
		try
		{
			int _type = IGNORED;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:189:9: ( '$' IDENTIFIER '=' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:189:11: '$' IDENTIFIER '='
			{
	...
	private void mSTARTSWITH()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:192:2: ( 'startswith' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:192:4: 'startswith'
			{
			DebugLocation(192, 4);
			Match("startswith"); 
	...
	private void mENDSWITH()
	{
		...
		try
		{
			int _type = ENDSWITH;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:195:2: ( 'endswith' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:195:4: 'endswith'
			{
			DebugLocation(195, 4);
			Match("endswith"); 
	...
	private void mSUBSTRINGOF()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:198:2: ( 'substringof' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:198:4: 'substringof'
			{
			DebugLocation(198, 4);
			Match("substringof"); 
	...
	private void mTOLOWER()
	{
		...
		try
		{
			int _type = TOLOWER;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:201:2: ( 'tolower' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:201:4: 'tolower'
			{
			DebugLocation(201, 4);
			Match("tolower"); 
	...
	private void mTOUPPER()
	{
		...
		try
		{
			int _type = TOUPPER;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:204:2: ( 'toupper' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:204:4: 'toupper'
			{
			DebugLocation(204, 4);
			Match("toupper"); 
	...
	private void mYEAR()
	{
		...
		try
		{
			int _type = YEAR;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:207:2: ( 'year' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:207:4: 'year'
			{
			DebugLocation(207, 4);
			Match("year"); 
	...
	private void mYEARS()
	{
		...
		try
		{
			int _type = YEARS;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:210:2: ( 'years' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:210:4: 'years'
			{
			DebugLocation(210, 4);
			Match("years"); 
	...
	private void mMONTH()
	{
		...
		try
		{
			int _type = MONTH;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:213:2: ( 'month' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:213:4: 'month'
			{
			DebugLocation(213, 4);
			Match("month"); 
	...
	private void mDAY()
	{
		...
		try
		{
			int _type = DAY;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:216:2: ( 'day' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:216:4: 'day'
			{
			DebugLocation(216, 4);
			Match("day"); 
	...
	private void mDAYS()
	{
		...
		try
		{
			int _type = DAYS;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:219:2: ( 'days' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:219:4: 'days'
			{
			DebugLocation(219, 4);
			Match("days"); 
	...
	private void mHOUR()
	{
		...
		try
		{
			int _type = HOUR;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:222:2: ( 'hour' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:222:4: 'hour'
			{
			DebugLocation(222, 4);
			Match("hour"); 
	...
	private void mHOURS()
	{
		...
		try
		{
			int _type = HOURS;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:225:2: ( 'hours' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:225:4: 'hours'
			{
			DebugLocation(225, 4);
			Match("hours"); 
	...
	private void mMINUTE()
	{
		...
		try
		{
			int _type = MINUTE;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:228:2: ( 'minute' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:228:4: 'minute'
			{
			DebugLocation(228, 4);
			Match("minute"); 
	...
	private void mMINUTES()
	{
		...
		try
		{
			int _type = MINUTES;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:231:2: ( 'minutes' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:231:4: 'minutes'
			{
			DebugLocation(231, 4);
			Match("minutes"); 
	...
	private void mSECOND()
	{
		...
		try
		{
			int _type = SECOND;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:234:2: ( 'second' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:234:4: 'second'
			{
			DebugLocation(234, 4);
			Match("second"); 
	...
	private void mSECONDS()
	{
		...
		try
		{
			int _type = SECONDS;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:237:2: ( 'seconds' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:237:4: 'seconds'
			{
			DebugLocation(237, 4);
			Match("seconds"); 
	...
	private void mANY()
	{
		...
		try
		{
			int _type = ANY;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:239:5: ( 'any' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:239:8: 'any'
			{
			DebugLocation(239, 8);
			Match("any"); 
	...
	private void mALL()
	{
		...
		try
		{
			int _type = ALL;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:241:5: ( 'all' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:241:7: 'all'
			{
			DebugLocation(241, 7);
			Match("all"); 
	...
	private void mCOUNT()
	{
		...
		try
		{
			int _type = COUNT;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:243:7: ( 'count' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:243:9: 'count'
			{
			DebugLocation(243, 9);
			Match("count"); 
	...
	private void mMIN()
	{
		...
		try
		{
			int _type = MIN;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:245:5: ( 'min' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:245:7: 'min'
			{
			DebugLocation(245, 7);
			Match("min"); 
	...
	private void mMAX()
	{
		...
		try
		{
			int _type = MAX;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:247:5: ( 'max' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:247:7: 'max'
			{
			DebugLocation(247, 7);
			Match("max"); 
	...
	private void mSUM()
	{
		...
		try
		{
			int _type = SUM;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:249:5: ( 'sum' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:249:7: 'sum'
			{
			DebugLocation(249, 7);
			Match("sum"); 
	...
	private void mAVERAGE()
	{
		...
		try
		{
			int _type = AVERAGE;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:251:9: ( 'average' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:251:11: 'average'
			{
	...
	private void mINT()
	{
		...
		try
		{
			int _type = INT;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:253:5: ( ( '-' )? ( '0' .. '9' )+ )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:253:7: ( '-' )? ( '0' .. '9' )+
			{
			DebugLocation(253, 7);
			// LinqToQuerystring.g:253:7: ( '-' )?
			int alt1=2;
			...
			// LinqToQuerystring.g:253:17: ( '0' .. '9' )+
			int cnt2=0;
	...
	private void mLONG()
	{
		...
		try
		{
			int _type = LONG;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:255:6: ( ( '-' )? ( '0' .. '9' )+ 'L' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:255:8: ( '-' )? ( '0' .. '9' )+ 'L'
			{
			DebugLocation(255, 8);
			// LinqToQuerystring.g:255:8: ( '-' )?
			int alt3=2;
			...
			// LinqToQuerystring.g:255:15: ( '0' .. '9' )+
			int cnt4=0;
	...
	private void mDOUBLE()
	{
		...
		try
		{
			int _type = DOUBLE;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:257:8: ( ( '-' )? ( '0' .. '9' )+ '.' ( '0' .. '9' )+ ( 'd' )? )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:257:10: ( '-' )? ( '0' .. '9' )+ '.' ( '0' .. '9' )+ ( 'd' )?
			{
			DebugLocation(257, 10);
			// LinqToQuerystring.g:257:10: ( '-' )?
			int alt5=2;
			...
			// LinqToQuerystring.g:257:17: ( '0' .. '9' )+
			int cnt6=0;
			...
			// LinqToQuerystring.g:257:33: ( '0' .. '9' )+
			int cnt7=0;
	...
	private void mSINGLE()
	{
		...
		try
		{
			int _type = SINGLE;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:259:8: ( ( '-' )? ( '0' .. '9' )+ '.' ( '0' .. '9' )+ 'f' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:259:10: ( '-' )? ( '0' .. '9' )+ '.' ( '0' .. '9' )+ 'f'
			{
			DebugLocation(259, 10);
			// LinqToQuerystring.g:259:10: ( '-' )?
			int alt9=2;
			...
			// LinqToQuerystring.g:259:17: ( '0' .. '9' )+
			int cnt10=0;
			...
			// LinqToQuerystring.g:259:33: ( '0' .. '9' )+
			int cnt11=0;
	...
	private void mDECIMAL()
	{
		...
		try
		{
			int _type = DECIMAL;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:261:9: ( ( '-' )? ( '0' .. '9' )+ '.' ( '0' .. '9' )+ 'm' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:261:11: ( '-' )? ( '0' .. '9' )+ '.' ( '0' .. '9' )+ 'm'
			{
			DebugLocation(261, 11);
			// LinqToQuerystring.g:261:11: ( '-' )?
			int alt12=2;
			...
			// LinqToQuerystring.g:261:18: ( '0' .. '9' )+
			int cnt13=0;
			...
			// LinqToQuerystring.g:261:34: ( '0' .. '9' )+
			int cnt14=0;
	...
	private void mBOOL()
	{
		...
		try
		{
			int _type = BOOL;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:263:6: ( ( 'true' | 'false' ) )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:263:8: ( 'true' | 'false' )
			{
			DebugLocation(263, 8);
			// LinqToQuerystring.g:263:8: ( 'true' | 'false' )
			int alt15=2;
			...
			case 1:
				DebugEnterAlt(1);
				// LinqToQuerystring.g:263:9: 'true'
				{
				DebugLocation(263, 9);
				Match("true"); 
			...
			case 2:
				DebugEnterAlt(2);
				// LinqToQuerystring.g:263:18: 'false'
				{
	...
	private void mNULL()
	{
		...
		try
		{
			int _type = NULL;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:265:6: ( 'null' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:265:8: 'null'
			{
			DebugLocation(265, 8);
			Match("null"); 
	...
	private void mDATETIME()
	{
		...
		try
		{
			int _type = DATETIME;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:268:2: ( 'datetime\\'' ( '0' .. '9' )+ '-' ( '0' .. '9' )+ ( '-' )+ ( '0' .. '9' )+ 'T' ( '0' .. '9' )+ ':' ( '0' .. '9' )+ ( ':' ( '0' .. '9' )+ ( '.' ( '0' .. '9' )+ )* )* ( 'Z' )? '\\'' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:268:4: 'datetime\\'' ( '0' .. '9' )+ '-' ( '0' .. '9' )+ ( '-' )+ ( '0' .. '9' )+ 'T' ( '0' .. '9' )+ ':' ( '0' .. '9' )+ ( ':' ( '0' .. '9' )+ ( '.' ( '0' .. '9' )+ )* )* ( 'Z' )? '\\''
			{
			DebugLocation(268, 4);
			Match("datetime'"); 

			DebugLocation(268, 20);
			// LinqToQuerystring.g:268:20: ( '0' .. '9' )+
			int cnt16=0;
			...
			// LinqToQuerystring.g:268:34: ( '0' .. '9' )+
			int cnt17=0;
			...
			// LinqToQuerystring.g:268:50: ( '0' .. '9' )+
			int cnt19=0;
			...
			// LinqToQuerystring.g:268:64: ( '0' .. '9' )+
			int cnt20=0;
			...
			// LinqToQuerystring.g:268:78: ( '0' .. '9' )+
			int cnt21=0;
			...
			// LinqToQuerystring.g:268:85: ( ':' ( '0' .. '9' )+ ( '.' ( '0' .. '9' )+ )* )*
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// LinqToQuerystring.g:268:86: ':' ( '0' .. '9' )+ ( '.' ( '0' .. '9' )+ )*
					{
					DebugLocation(268, 86);
					Match(':'); 
					DebugLocation(268, 93);
					// LinqToQuerystring.g:268:93: ( '0' .. '9' )+
					int cnt22=0;
					...
					DebugLocation(268, 100);
					// LinqToQuerystring.g:268:100: ( '.' ( '0' .. '9' )+ )*
					...
					while (true)
					{
						...
						case 1:
							DebugEnterAlt(1);
							// LinqToQuerystring.g:268:101: '.' ( '0' .. '9' )+
							{
							DebugLocation(268, 101);
							Match('.'); 
							DebugLocation(268, 108);
							// LinqToQuerystring.g:268:108: ( '0' .. '9' )+
							int cnt23=0;
			...
			DebugLocation(268, 119);
			// LinqToQuerystring.g:268:119: ( 'Z' )?
			int alt26=2;
			...
			case 1:
				DebugEnterAlt(1);
				// LinqToQuerystring.g:268:120: 'Z'
				{
				DebugLocation(268, 120);
				Match('Z'); 
	...
	private void mGUID()
	{
		...
		try
		{
			int _type = GUID;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:270:6: ( 'guid\\'' HEX_PAIR HEX_PAIR HEX_PAIR HEX_PAIR '-' HEX_PAIR HEX_PAIR '-' HEX_PAIR HEX_PAIR '-' HEX_PAIR HEX_PAIR '-' HEX_PAIR HEX_PAIR HEX_PAIR HEX_PAIR HEX_PAIR HEX_PAIR '\\'' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:270:8: 'guid\\'' HEX_PAIR HEX_PAIR HEX_PAIR HEX_PAIR '-' HEX_PAIR HEX_PAIR '-' HEX_PAIR HEX_PAIR '-' HEX_PAIR HEX_PAIR '-' HEX_PAIR HEX_PAIR HEX_PAIR HEX_PAIR HEX_PAIR HEX_PAIR '\\''
			{
			DebugLocation(270, 8);
			Match("guid'"); 
			...
			mHEX_PAIR(); 
			DebugLocation(270, 97);
			Match('-'); 
			DebugLocation(270, 101);
			mHEX_PAIR(); 
			DebugLocation(270, 110);
			mHEX_PAIR(); 
			DebugLocation(270, 119);
			Match('-'); 
			DebugLocation(270, 123);
			mHEX_PAIR(); 
			DebugLocation(270, 132);
			mHEX_PAIR(); 
			DebugLocation(270, 141);
			mHEX_PAIR(); 
			DebugLocation(270, 150);
			mHEX_PAIR(); 
			DebugLocation(270, 159);
			mHEX_PAIR(); 
	...
	private void mBYTE()
	{
		...
		try
		{
			int _type = BYTE;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:272:6: ( '0x' HEX_PAIR )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:272:8: '0x' HEX_PAIR
			{
			DebugLocation(272, 8);
			Match("0x"); 
	...
	private void mSPACE()
	{
		...
		try
		{
			int _type = SPACE;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:274:7: ( ( ' ' | '\\t' )+ )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:274:9: ( ' ' | '\\t' )+
			{
			DebugLocation(274, 9);
			// LinqToQuerystring.g:274:9: ( ' ' | '\\t' )+
			int cnt27=0;
	...
	private void mNEWLINE()
	{
		...
		try
		{
			int _type = NEWLINE;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:276:9: ( ( '\\r' | '\\n' )+ )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:276:11: ( '\\r' | '\\n' )+
			{
	...
	private void mDYNAMICIDENTIFIER()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:279:2: ( '[' ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )+ ']' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:279:4: '[' ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )+ ']'
			{
			DebugLocation(279, 4);
			Match('['); 
			DebugLocation(279, 8);
			// LinqToQuerystring.g:279:8: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )+
			int cnt29=0;
	...
	private void mHEX_PAIR()
	{
		...
		try
		{
			// LinqToQuerystring.g:284:2: ( HEX_DIGIT HEX_DIGIT )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:284:4: HEX_DIGIT HEX_DIGIT
			{
			DebugLocation(284, 4);
			mHEX_DIGIT(); 
	...
	private void mIDENTIFIER()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:286:2: ( ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )* )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:286:4: ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
			{
			DebugLocation(286, 4);
			...
			// LinqToQuerystring.g:286:24: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
	...
	private void mSTRING()
	{
		...
		try
		{
			int _type = STRING;
			int _channel = DefaultTokenChannel;
			// LinqToQuerystring.g:288:9: ( '\\'' ( ESC_SEQ |~ ( '\\\\' | '\\'' ) )* '\\'' )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:288:12: '\\'' ( ESC_SEQ |~ ( '\\\\' | '\\'' ) )* '\\''
			{
			DebugLocation(288, 12);
			Match('\''); 
			DebugLocation(288, 17);
			// LinqToQuerystring.g:288:17: ( ESC_SEQ |~ ( '\\\\' | '\\'' ) )*
			...
			while (true)
			{
				...
				case 1:
					DebugEnterAlt(1);
					// LinqToQuerystring.g:288:18: ESC_SEQ
					{
	...
	private void mHEX_DIGIT()
	{
		...
		try
		{
			// LinqToQuerystring.g:292:11: ( ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:
			{
	...
	private void mESC_SEQ()
	{
		...
		try
		{
			// LinqToQuerystring.g:296:2: ( '\\'\\'' | '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UNICODE_ESC | OCTAL_ESC )
			int alt32=4;
			...
			case 2:
				DebugEnterAlt(2);
				// LinqToQuerystring.g:297:5: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' )
				{
				DebugLocation(297, 5);
				Match('\\'); 
			...
			case 3:
				DebugEnterAlt(3);
				// LinqToQuerystring.g:298:5: UNICODE_ESC
				{
				DebugLocation(298, 5);
				mUNICODE_ESC(); 
			...
			case 4:
				DebugEnterAlt(4);
				// LinqToQuerystring.g:299:5: OCTAL_ESC
				{
				DebugLocation(299, 5);
				mOCTAL_ESC(); 
	...
	private void mOCTAL_ESC()
	{
		...
		try
		{
			// LinqToQuerystring.g:304:3: ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) )
			int alt33=3;
			...
			case 1:
				DebugEnterAlt(1);
				// LinqToQuerystring.g:304:7: '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' )
				{
				DebugLocation(304, 7);
				Match('\\'); 
			...
			case 2:
				DebugEnterAlt(2);
				// LinqToQuerystring.g:305:7: '\\\\' ( '0' .. '7' ) ( '0' .. '7' )
				{
				DebugLocation(305, 7);
				Match('\\'); 
	...
	private void mUNICODE_ESC()
	{
		...
		try
		{
			// LinqToQuerystring.g:311:3: ( '\\\\' 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT )
			DebugEnterAlt(1);
			// LinqToQuerystring.g:311:7: '\\\\' 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT
			{
			DebugLocation(311, 7);
			Match('\\'); 
	...
	public override void mTokens()
	{
		...
		case 1:
			DebugEnterAlt(1);
			// LinqToQuerystring.g:1:10: T__70
			{
			DebugLocation(1, 10);
			mT__70(); 
		...
		case 2:
			DebugEnterAlt(2);
			// LinqToQuerystring.g:1:16: T__71
			{
			DebugLocation(1, 16);
			mT__71(); 
		...
		case 3:
			DebugEnterAlt(3);
			// LinqToQuerystring.g:1:22: T__72
			{
			DebugLocation(1, 22);
			mT__72(); 
		...
		case 4:
			DebugEnterAlt(4);
			// LinqToQuerystring.g:1:28: T__73
			{
			DebugLocation(1, 28);
			mT__73(); 
		...
		case 5:
			DebugEnterAlt(5);
			// LinqToQuerystring.g:1:34: T__74
			{
			DebugLocation(1, 34);
			mT__74(); 
		...
		case 6:
			DebugEnterAlt(6);
			// LinqToQuerystring.g:1:40: T__75
			{
			DebugLocation(1, 40);
			mT__75(); 
		...
		case 7:
			DebugEnterAlt(7);
			// LinqToQuerystring.g:1:46: ASSIGN
			{
			DebugLocation(1, 46);
			mASSIGN(); 
		...
		case 8:
			DebugEnterAlt(8);
			// LinqToQuerystring.g:1:53: EQUALS
			{
			DebugLocation(1, 53);
			mEQUALS(); 
		...
		case 9:
			DebugEnterAlt(9);
			// LinqToQuerystring.g:1:60: NOTEQUALS
			{
			DebugLocation(1, 60);
			mNOTEQUALS(); 
		...
		case 10:
			DebugEnterAlt(10);
			// LinqToQuerystring.g:1:70: GREATERTHAN
			{
			DebugLocation(1, 70);
			mGREATERTHAN(); 
		...
		case 11:
			DebugEnterAlt(11);
			// LinqToQuerystring.g:1:82: GREATERTHANOREQUAL
			{
			DebugLocation(1, 82);
			mGREATERTHANOREQUAL(); 
		...
		case 12:
			DebugEnterAlt(12);
			// LinqToQuerystring.g:1:101: LESSTHAN
			{
			DebugLocation(1, 101);
			mLESSTHAN(); 
		...
		case 13:
			DebugEnterAlt(13);
			// LinqToQuerystring.g:1:110: LESSTHANOREQUAL
			{
			DebugLocation(1, 110);
			mLESSTHANOREQUAL(); 
		...
		case 18:
			DebugEnterAlt(18);
			// LinqToQuerystring.g:1:141: DESC
			{
			DebugLocation(1, 141);
			mDESC(); 
		...
		case 19:
			DebugEnterAlt(19);
			// LinqToQuerystring.g:1:146: ALLPAGES
			{
			DebugLocation(1, 146);
			mALLPAGES(); 
		...
		case 20:
			DebugEnterAlt(20);
			// LinqToQuerystring.g:1:155: NONE
			{
			DebugLocation(1, 155);
			mNONE(); 
		...
		case 21:
			DebugEnterAlt(21);
			// LinqToQuerystring.g:1:160: SKIP
			{
			DebugLocation(1, 160);
			mSKIP(); 
		...
		case 23:
			DebugEnterAlt(23);
			// LinqToQuerystring.g:1:169: FILTER
			{
			DebugLocation(1, 169);
			mFILTER(); 
		...
		case 24:
			DebugEnterAlt(24);
			// LinqToQuerystring.g:1:176: ORDERBY
			{
			DebugLocation(1, 176);
			mORDERBY(); 
		...
		case 25:
			DebugEnterAlt(25);
			// LinqToQuerystring.g:1:184: SELECT
			{
			DebugLocation(1, 184);
			mSELECT(); 
		...
		case 26:
			DebugEnterAlt(26);
			// LinqToQuerystring.g:1:191: INLINECOUNT
			{
			DebugLocation(1, 191);
			mINLINECOUNT(); 
		...
		case 27:
			DebugEnterAlt(27);
			// LinqToQuerystring.g:1:203: EXPAND
			{
			DebugLocation(1, 203);
			mEXPAND(); 
		...
		case 28:
			DebugEnterAlt(28);
			// LinqToQuerystring.g:1:210: IGNORED
			{
			DebugLocation(1, 210);
			mIGNORED(); 
		...
		case 29:
			DebugEnterAlt(29);
			// LinqToQuerystring.g:1:218: STARTSWITH
			{
			DebugLocation(1, 218);
			mSTARTSWITH(); 
		...
		case 30:
			DebugEnterAlt(30);
			// LinqToQuerystring.g:1:229: ENDSWITH
			{
			DebugLocation(1, 229);
			mENDSWITH(); 
		...
		case 31:
			DebugEnterAlt(31);
			// LinqToQuerystring.g:1:238: SUBSTRINGOF
			{
			DebugLocation(1, 238);
			mSUBSTRINGOF(); 
		...
		case 32:
			DebugEnterAlt(32);
			// LinqToQuerystring.g:1:250: TOLOWER
			{
			DebugLocation(1, 250);
			mTOLOWER(); 
		...
		case 33:
			DebugEnterAlt(33);
			// LinqToQuerystring.g:1:258: TOUPPER
			{
			DebugLocation(1, 258);
			mTOUPPER(); 
		...
		case 34:
			DebugEnterAlt(34);
			// LinqToQuerystring.g:1:266: YEAR
			{
			DebugLocation(1, 266);
			mYEAR(); 
		...
		case 35:
			DebugEnterAlt(35);
			// LinqToQuerystring.g:1:271: YEARS
			{
			DebugLocation(1, 271);
			mYEARS(); 
		...
		case 36:
			DebugEnterAlt(36);
			// LinqToQuerystring.g:1:277: MONTH
			{
			DebugLocation(1, 277);
			mMONTH(); 
		...
		case 38:
			DebugEnterAlt(38);
			// LinqToQuerystring.g:1:287: DAYS
			{
			DebugLocation(1, 287);
			mDAYS(); 
		...
		case 39:
			DebugEnterAlt(39);
			// LinqToQuerystring.g:1:292: HOUR
			{
			DebugLocation(1, 292);
			mHOUR(); 
		...
		case 40:
			DebugEnterAlt(40);
			// LinqToQuerystring.g:1:297: HOURS
			{
			DebugLocation(1, 297);
			mHOURS(); 
		...
		case 41:
			DebugEnterAlt(41);
			// LinqToQuerystring.g:1:303: MINUTE
			{
			DebugLocation(1, 303);
			mMINUTE(); 
		...
		case 42:
			DebugEnterAlt(42);
			// LinqToQuerystring.g:1:310: MINUTES
			{
			DebugLocation(1, 310);
			mMINUTES(); 
		...
		case 43:
			DebugEnterAlt(43);
			// LinqToQuerystring.g:1:318: SECOND
			{
			DebugLocation(1, 318);
			mSECOND(); 
		...
		case 44:
			DebugEnterAlt(44);
			// LinqToQuerystring.g:1:325: SECONDS
			{
			DebugLocation(1, 325);
			mSECONDS(); 
		...
		case 47:
			DebugEnterAlt(47);
			// LinqToQuerystring.g:1:341: COUNT
			{
			DebugLocation(1, 341);
			mCOUNT(); 
		...
		case 51:
			DebugEnterAlt(51);
			// LinqToQuerystring.g:1:359: AVERAGE
			{
			DebugLocation(1, 359);
			mAVERAGE(); 
		...
		case 53:
			DebugEnterAlt(53);
			// LinqToQuerystring.g:1:371: LONG
			{
			DebugLocation(1, 371);
			mLONG(); 
		...
		case 54:
			DebugEnterAlt(54);
			// LinqToQuerystring.g:1:376: DOUBLE
			{
			DebugLocation(1, 376);
			mDOUBLE(); 
		...
		case 55:
			DebugEnterAlt(55);
			// LinqToQuerystring.g:1:383: SINGLE
			{
			DebugLocation(1, 383);
			mSINGLE(); 
		...
		case 56:
			DebugEnterAlt(56);
			// LinqToQuerystring.g:1:390: DECIMAL
			{
			DebugLocation(1, 390);
			mDECIMAL(); 
		...
		case 57:
			DebugEnterAlt(57);
			// LinqToQuerystring.g:1:398: BOOL
			{
			DebugLocation(1, 398);
			mBOOL(); 
		...
		case 58:
			DebugEnterAlt(58);
			// LinqToQuerystring.g:1:403: NULL
			{
			DebugLocation(1, 403);
			mNULL(); 
		...
		case 59:
			DebugEnterAlt(59);
			// LinqToQuerystring.g:1:408: DATETIME
			{
			DebugLocation(1, 408);
			mDATETIME(); 
		...
		case 60:
			DebugEnterAlt(60);
			// LinqToQuerystring.g:1:417: GUID
			{
			DebugLocation(1, 417);
			mGUID(); 
		...
		case 61:
			DebugEnterAlt(61);
			// LinqToQuerystring.g:1:422: BYTE
			{
			DebugLocation(1, 422);
			mBYTE(); 
		...
		case 62:
			DebugEnterAlt(62);
			// LinqToQuerystring.g:1:427: SPACE
			{
			DebugLocation(1, 427);
			mSPACE(); 
		...
		case 63:
			DebugEnterAlt(63);
			// LinqToQuerystring.g:1:433: NEWLINE
			{
			DebugLocation(1, 433);
			mNEWLINE(); 
		...
		case 64:
			DebugEnterAlt(64);
			// LinqToQuerystring.g:1:441: DYNAMICIDENTIFIER
			{
			DebugLocation(1, 441);
			mDYNAMICIDENTIFIER(); 
		...
		case 65:
			DebugEnterAlt(65);
			// LinqToQuerystring.g:1:459: IDENTIFIER
			{
			DebugLocation(1, 459);
			mIDENTIFIER(); 
		...
		case 66:
			DebugEnterAlt(66);
			// LinqToQuerystring.g:1:470: STRING
			{
			DebugLocation(1, 470);
			mSTRING(); 
