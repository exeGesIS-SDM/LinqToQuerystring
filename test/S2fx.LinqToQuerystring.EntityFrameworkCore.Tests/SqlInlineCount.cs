namespace LinqToQueryString.EntityFrameworkCore.Tests
{
    ...
    {
        Because of = () => concreteResult = testDb.ConcreteClasses.LinqToQuerystring("?$inlinecount=none").ToList();
    ...
    {
        Because of = () => inlineCountResult = testDb.ConcreteClasses.LinqToQuerystring<ConcreteClass, Dictionary<string, object>>("?$inlinecount=allpages");
    ...
    {
        Because of = () => inlineCountResult = testDb.ConcreteClasses.LinqToQuerystring<ConcreteClass, Dictionary<string, object>>("?$select=Name,Age&$inlinecount=allpages");
    ...
    {
        Because of = () => inlineCountResult = testDb.ConcreteClasses.LinqToQuerystring<ConcreteClass, Dictionary<string, object>>("?$filter=Age ge 3&$inlinecount=allpages");
    ...
    {
        Because of = () => inlineCountResult = testDb.ConcreteClasses.LinqToQuerystring<ConcreteClass, Dictionary<string, object>>("?$orderby=Age desc&$inlinecount=allpages");
    ...
    {
        Because of = () => inlineCountResult = testDb.ConcreteClasses.LinqToQuerystring<ConcreteClass, Dictionary<string, object>>("?$top=3&$inlinecount=allpages");
    ...
    {
        Because of = () => inlineCountResult = testDb.ConcreteClasses.LinqToQuerystring<ConcreteClass, Dictionary<string, object>>("?$orderby=Name&$top=3&$select=Name,Age&$inlinecount=allpages");
    ...
    {
        Because of = () => inlineCountResult = testDb.ConcreteClasses.LinqToQuerystring<ConcreteClass, Dictionary<string, object>>("?$orderby=Name&$skip=2&$top=2&$inlinecount=allpages");
    ...
    {
        Because of = () => inlineCountResult = testDb.ConcreteClasses.LinqToQuerystring<ConcreteClass, Dictionary<string, object>>("?$orderby=Name&$skip=2&$top=2&$select=Name,Age&$inlinecount=allpages");
    ...
    {
        Because of = () => inlineCountResult = testDb.ConcreteClasses.LinqToQuerystring<ConcreteClass, Dictionary<string, object>>("?$orderby=Name&$filter=Age ge 3&$skip=2&$top=2&$inlinecount=allpages");
    ...
    {
        Because of = () => inlineCountResult = testDb.ConcreteClasses.LinqToQuerystring<ConcreteClass, Dictionary<string, object>>("?$orderby=Name&$filter=Age ge 3&$skip=2&$top=2&$select=Name,Age&$inlinecount=allpages");
