namespace LinqToQueryString.UnitTests
{
    ...
    public class When_using_eq_filter_on_a_decimal : Filtering
    {
        private Because of = () => result = concreteCollection.AsQueryable().LinqToQuerystring("?$filter=Score eq 0.4m");

        private It should_return_two_records = () => result.Count().ShouldEqual(2);

        private It should_only_return_records_where_value_is_444point444 = () => result.ShouldEachConformTo(o => o.Score == 0.4m);
    }

    public class When_using_eq_filter_on_a_decimal_without_m_suffix : Filtering
    {
        private Because of = () => result = concreteCollection.AsQueryable().LinqToQuerystring("?$filter=Score eq 0.4");
    ...
    public class When_using_eq_filter_on_a_decimal_and_a_double : Filtering
    {
        private Because of = () => result = concreteCollection.AsQueryable().LinqToQuerystring("?$filter=Score eq 0.4m and Value eq 444.444");
    ...
    public class When_using_eq_filter_on_a_negative_decimal : Filtering
    {
        private Because of = () => result = concreteCollection.AsQueryable().LinqToQuerystring("?$filter=Score gt -0.4m");
    ...
    public class When_using_not_eq_filter_on_a_decimal : Filtering
    {
        private Because of = () => result = concreteCollection.AsQueryable().LinqToQuerystring("?$filter=not Score eq 0.4m");

        private It should_return_two_records = () => result.Count().ShouldEqual(9);

        private It should_only_return_records_where_value_is_not_444point444 = () => result.ShouldEachConformTo(o => o.Score != 0.4m);
    }

    public class When_using_ne_filter_on_a_decimal : Filtering
    {
        private Because of = () => result = concreteCollection.AsQueryable().LinqToQuerystring("?$filter=Score ne 0.4m");
    ...
    public class When_using_not_ne_filter_on_a_decimal : Filtering
    {
        private Because of = () => result = concreteCollection.AsQueryable().LinqToQuerystring("?$filter=not Score ne 0.4m");
    ...
    public class When_using_gt_filter_on_a_decimal : Filtering
    {
        private Because of = () => result = concreteCollection.AsQueryable().LinqToQuerystring("?$filter=Score gt 0.3m");

        private It should_return_two_records = () => result.Count().ShouldEqual(3);

        private It should_only_return_records_where_value_is_greater_than_333point333 = () => result.ShouldEachConformTo(o => o.Score > 0.3m);
    }

    public class When_using_not_gt_filter_on_a_decimal : Filtering
    {
        private Because of = () => result = concreteCollection.AsQueryable().LinqToQuerystring("?$filter=not Score gt 0.3m");

        private It should_return_two_records = () => result.Count().ShouldEqual(8);

        private It should_only_return_records_where_value_is_not_greater_than_333point333 = () => result.ShouldEachConformTo(o => !(o.Score > 0.3m));
    }

    public class When_using_ge_filter_on_a_decimal : Filtering
    {
        private Because of = () => result = concreteCollection.AsQueryable().LinqToQuerystring("?$filter=Score ge 0.3m");

        private It should_return_two_records = () => result.Count().ShouldEqual(6);

        private It should_only_return_records_where_value_is_greater_than_or_equal_to_333point333 = () => result.ShouldEachConformTo(o => o.Score >= 0.3m);
    }

    public class When_using_not_ge_filter_on_a_decimal : Filtering
    {
        private Because of = () => result = concreteCollection.AsQueryable().LinqToQuerystring("?$filter=not Score ge 0.3m");

        private It should_return_two_records = () => result.Count().ShouldEqual(5);

        private It should_only_return_records_where_value_is_not_greater_than_or_equal_to_333point333 = () => result.ShouldEachConformTo(o => !(o.Score >= 0.3m));
    }

    public class When_using_lt_filter_on_a_decimal : Filtering
    {
        private Because of = () => result = concreteCollection.AsQueryable().LinqToQuerystring("?$filter=Score lt 0.3m");

        private It should_return_two_records = () => result.Count().ShouldEqual(5);

        private It should_only_return_records_where_value_is_less_than_333point333 = () => result.ShouldEachConformTo(o => o.Score < 0.3m);
    }

    public class When_using_not_lt_filter_on_a_decimal : Filtering
    {
        private Because of = () => result = concreteCollection.AsQueryable().LinqToQuerystring("?$filter=not Score lt 0.3m");

        private It should_return_two_records = () => result.Count().ShouldEqual(6);

        private It should_only_return_records_where_value_is_not_less_than_333point333 = () => result.ShouldEachConformTo(o => !(o.Score < 0.3m));
    }

    public class When_using_le_filter_on_a_decimal : Filtering
    {
        private Because of = () => result = concreteCollection.AsQueryable().LinqToQuerystring("?$filter=Score le 0.3m");

        private It should_return_two_records = () => result.Count().ShouldEqual(8);

        private It should_only_return_records_where_value_is_less_than_or_equal_to_333point333 = () => result.ShouldEachConformTo(o => o.Score <= 0.3m);
    }

    public class When_using_not_le_filter_on_a_decimal : Filtering
    {
        private Because of = () => result = concreteCollection.AsQueryable().LinqToQuerystring("?$filter=not Score le 0.3m");

        private It should_return_two_records = () => result.Count().ShouldEqual(3);

        private It should_only_return_records_where_value_is_not_less_than_or_equal_to_333point333 = () => result.ShouldEachConformTo(o => !(o.Score <= 0.3m));
    }
